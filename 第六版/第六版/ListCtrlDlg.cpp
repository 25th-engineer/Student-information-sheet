...
BOOL CListCtrlDlg::OnInitDialog()
{
	...
	m_List.InsertColumn(m, "序号", LVCFMT_CENTER, 75);
	m_List.InsertColumn(m + 1, "姓名", LVCFMT_CENTER, 75);
	m_List.InsertColumn(m + 2, "学号", LVCFMT_CENTER, 75);
	m_List.InsertColumn(m + 3, "班级", LVCFMT_CENTER, 75);
	...
	//ColumnInfo.strNumber = "序号";
	//ColumnInfo.strName = "姓名";
	//ColumnInfo.strID = "学号";
	//ColumnInfo.strGrade = "班级";
